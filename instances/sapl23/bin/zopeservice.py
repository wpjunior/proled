...
PYTHON = r'/var/interlegis/SAPL-2.3/Python-2.4/bin/python2.4'
SOFTWARE_HOME=r'/var/interlegis/SAPL-2.3/Zope-2.9/lib/python'
INSTANCE_HOME = r'/var/interlegis/SAPL-2.3/instances/sapl23'
ZOPE_HOME = r'/var/interlegis/SAPL-2.3/Zope-2.9'
