...
if dumpBanco==0:
  if documentos==0:
   retorno='Backup concluido!  <a href="javascript:history.go(-1)">[ Voltar ]</a>'
  else: retorno='Problemas no salvamento dos documentos.  <a href="javascript:history.go(-1)">[ Voltar ]</a>'
else: 
   retorno='Salvamento de dados do banco falhou. Tente novamente! <a href="javascript:history.go(-1)">[ Voltar ]</a>'
