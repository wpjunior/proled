...
def cabecalho(dic_cabecalho,imagem):
    ...
    tmp_data+='\t\t\t\t<setFont name="Helvetica" size="14"/>\n'
    tmp_data+='\t\t\t\t<drawString x="5cm" y="26.5cm">' + dic_cabecalho['nom_estado'] + '</drawString>\n'
    tmp_data+='\t\t\t\t<setFont name="Helvetica" size="15"/>\n'
    tmp_data+='\t\t\t\t<drawCentredString x="10.5cm" y="25.2cm">Relatório de Matérias</drawCentredString>\n'
...
def paraStyle():
    ...
    tmp_data+='\t\t<paraStyle name="P2" fontName="Helvetica" fontSize="10.0" leading="10" alignment="LEFT"/>\n'
    tmp_data+='\t</stylesheet>\n'
